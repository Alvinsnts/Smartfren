...
import { NgZone, ViewChild, ElementRef, ɵConsole } from '@angular/core';
    ...
    return new Observable((sub: any) => {
      google.maps.event.addListener(autocomplete, 'place_changed', () => {
        ...
        if (!place.geometry) {
          ...
          this.locationinfo.locationLat = place.geometry.location.lat();
          this.locationinfo.locationLong = place.geometry.location.lng();
          this.locationinfo.locationAddress = place.formatted_address;
          console.log('Search Lat', place.geometry.location.lat());
          console.log('Search Lng', place.geometry.location.lng());
          console.log("address name:", this.locationinfo.locationAddress );
          sub.next(place.geometry.location);
          //sub.complete();
        }
      });
